          ...
          <div className="space-y-6 text-gray-300">
            ...
            <section>
              ...
              <p>
                ...
                and agree to be bound by the terms and provisions of this agreement. These terms
                apply to all visitors, users, and others who access or use the Service. If you
            ...
            <section>
              ...
              <ul className="list-disc list-inside space-y-2 ml-4">
                ...
                <li>
                  **Prohibited Conduct:** You must not use the Service for any unlawful or
                  prohibited purpose, including unauthorized access to data or systems.
                </li>
              </ul>
            </section>
            ...
            <section>
              ...
              <p>
                ...
                remain the exclusive property of Career Risk Calculator and its licensors. Our
                trademarks and trade dress may not be used in connection with any product or service
                without the prior written consent of Career Risk Calculator.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                ...
                Terms. Upon termination, your right to use the Service will immediately cease. If
                you wish to terminate your account, you may simply discontinue using the Service or
                use the deletion option in the **Settings page**.
              </p>
            </section>
