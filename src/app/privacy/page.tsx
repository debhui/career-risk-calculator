          ...
          <div className="space-y-8 text-gray-300">
            ...
            <section>
              ...
              <p>
                ...
                committed to protecting the privacy of our users. This Privacy Policy describes how
                we collect, use, and disclose the personal information you provide when using our
              ...
              <ul className="list-disc list-inside space-y-3 ml-4">
                ...
                <li>
                  **Assessment Data:** Responses and inputs you provide during the career risk
                  assessment process (e.g., job history, industry, skills, risk tolerance). This
                  data is the core of the Service.
                </li>
                <li>
            ...
            <section>
              ...
              <ul className="list-disc list-inside space-y-3 ml-4">
                ...
                <li>
                  To **communicate with you** regarding service updates, security alerts, and
                  support.
                </li>
              ...
              <ul className="list-disc list-inside space-y-3 ml-4">
                <li>
                  **Service Providers:** With third-party service providers (like Supabase for
                  database hosting) who perform services on our behalf and are contractually
            ...
            <section>
              ...
              <p>
                ...
                about you. You can manage your consent status and delete your entire account via the
